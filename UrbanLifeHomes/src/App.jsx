        ...
        <div className="footer-grid">
          <div className="footer-col footer-about">
            ...
            <div className="footer-social">
              {s.social?.facebook && (
                <a href={s.social.facebook} target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Facebook">
              ...
              {s.social?.instagram && (
                <a href={s.social.instagram} target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Instagram">
                  <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
              ...
              {s.social?.linkedin && (
                <a href={s.social.linkedin} target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="LinkedIn">
                  <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
