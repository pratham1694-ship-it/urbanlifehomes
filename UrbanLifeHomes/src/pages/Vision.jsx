...
import visionImage from "../assets/FRONT copy.svg";
  ...
  return (
    <main className="vision-editorial">
      ...
      <section className="vision-manifesto">
        ...
        <div className="vision-image-wrap"><img src={visionImage} alt="Urban Life Homes architectural detail" /><span>Thoughtful by design</span></div>
